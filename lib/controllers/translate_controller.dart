...
class TranslateController extends ChangeNotifier {
  ...
  Future<void> loadTranslations() async {
    ...
    List translationJson = json.decode(await rootBundle.loadString('assets/translation.json'));
...
String translate(String text, {bool capitilize = true, Locale? locale}) {
 ...
 // return (resultText != null  && resultText != '' ? resultText : (capitilize ? "! ${text.inCaps}" : "! $text"));
  return resultText;
}
